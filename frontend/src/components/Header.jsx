...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`navbar navbar-expand-lg sticky-top navbar-light py-2 ${isSticky ? "navbar-sticky" : ""
          }`}
      >
        <div className="container">
          <Link to="/" className="navbar-brand" href="#">
            ...
            />
            <span className="text-white align-self-center fw-bolder ms-2">CMM</span>
          </Link>
          <button
            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <Link className="nav-link scrollto" to="/metodology">
                  <i className="fa-solid fa-book-open mx-1" /> Methodology
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link scrollto" to="/assesments">
                  <i className="fas fa-tasks mx-1" /> Assesments
                </Link>
              </li>
              <li className="nav-item">
